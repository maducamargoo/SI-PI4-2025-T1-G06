...
const IMG_BASE = "../../assets/img/minigame-rima/";
const JSON_PATH = "../../assets/data/rimas.json";   

let soundCorrect = null, soundWrong = null, bgMusic = null;
try {
    soundCorrect = new Audio("../../assets/audio/certo.mp3");
    soundWrong = new Audio("../../assets/audio/errado.mp3");
    ...
    if (index === r.correta) {
        ...
        setTimeout(() => {
            ...
            if (rodadaAtual < rodadas.length) {
                ...
                window.location.href = "final-rima.html";
            }
        }, 900);
